...
export class LLMClient {
  ...
  private buildSystemPrompt(url: string | null, pageText: string | null): string {
    const parts: string[] = [
      ...
      "- screenshot_page: Take a screenshot to visually analyze the page (BEST for understanding complex pages)",
      ...
      "- If get_page_elements returns empty, use screenshot_page to VISUALLY see the page — you can identify search boxes, buttons, forms from the screenshot",
      "- After seeing a screenshot, use type_text with a descriptive selector like 'search' or 'Sök' — it searches by placeholder text as fallback",
